    ...
    <main className='flex flex-grow w-full min-h-screen justify-start items-center'>
       <div className='flex flex-col justify-center items-center w-full min-h-screen'>
           <div className='flex flex-row justify-between items-start w-11/12 py-10  md:-ml-7'>
              ...
              <div className='md:w-80 md:mr-8'><span className='text-2xl font-Roboto font-medium'>{productQuantity} {displayQuantity}</span></div>
            </div>
        <div className='flex flex-col md:flex-row w-full justify-center items-center gap-x-2 pt-4'>
          
          <div className='flex flex-col justify-start items-start bg-white min-h-96 w-11/12 md:w-9/12 border
            ...
            '>              
                  ...
                  {products.map((product,index) => (
                    ...
                    <div className='flex flex-row w-full justify-between items-center '>
                      ...
                      '>
                          <div>
                            <button className='text-base  md:text-xl' onClick={()=>decreaseQuantity(product.id)} type='button'>
                               <FontAwesomeIcon icon={faMinus}/>
                            </button>
                          </div>
                          <div>
                             <button className='text-base md:text-xl' onClick={()=>increaseQuantity(product)} type='button'>
                             <FontAwesomeIcon icon={faPlus}/>
                             </button>
                          </div>
                          <div>
                          <button className='text-base md:text-xl' onClick={()=>deleteEntireProduct(product.id)} type='button'><FontAwesomeIcon icon={faTrash}/></button>
                          </div>                 
                      </div>
           ...
           <div className='  bg-white min-h-96 w-11/12 md:w-72 border rounded
              border-gray-300 '>
